    ...
    >
      <CardContent sx={{ textAlign: "center", position: "relative" }}>
        ...
        >
          ...
          <Typography
            variant="h6"
            sx={{ fontWeight: 700, ml: 1, color: "white" }}
          >
            {title}
          </Typography>
        </Box>
  ...
  const renderAreaChart = (
    ...
    >
      <CardContent sx={{ flexGrow: 1, pb: 2 }}>
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <Chip
              label={
                unit === "%"
                  ? `${Math.round(latestData[dataKey] || 0)}%`
                  : `${latestData[dataKey].toFixed(1)}${unit}`
              }
              size="small"
              sx={{
                bgcolor: `${color}20`,
        ...
        >
          🔄 Обновлено: {lastUpdate.toLocaleTimeString()} • Автообновление
          каждые 5 сек
        </Typography>
      </CardContent>
    </Card>
